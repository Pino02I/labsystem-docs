...
Import HDRI images or complete world setups.
...
Import complete world shader setup with all nodes.
...
- Node positions and settings
- Background/Environment Texture settings
- HDRI filepath (if present)

**Use for:**
- Share complete world setups between projects
- Import pre-configured lighting setups
...
Exports complete world shader data.
...
1. Click "Import World"
2. Select .json file
3. Complete world setup imported with all nodes
4. Assigned to active camera
