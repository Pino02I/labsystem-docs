...
All render operations automatically backup settings.

### Restore Settings
Manually restores the last backup.

**When to use:**
- After canceling render
...
Exports all render properties to JSON file.
...
- Auto-restore protects your settings automatically
